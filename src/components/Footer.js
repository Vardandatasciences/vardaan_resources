    ...
    <footer className="footer">
      ...
      <div className="footer-content">
        ...
        <div className="footer-column">
          <h3>Services</h3>
          <ul>
            <li><Link to="/captilization">Captilization</Link></li>
            <li><Link to="/valuation">Valuation</Link></li>
            <li><Link to="/bulf">Balance Useful Life(BULF)</Link></li>
            <li><Link to="/verification">Physical Verification</Link></li>
          </ul>
        </div>
        ...
        <div className="footer-column">
          ...
          <div className="contact-info">
            ...
            <p><i className="fas fa-phone"></i> +91 99662 22370</p>
            <p><i className="fas fa-envelope"></i> info@vardaanresources.com</p>
          </div>
        </div>
      </div>
